...
public class SilverHunter extends MonsterEntity {
    ...
    private SilverHunter.SummonSilverfishGoal friendsGoal;

    public SilverHunter(EntityType<? extends SilverHunter> p_i50195_1_, World p_i50195_2_) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(5, new SilverHunter.HideInStoneGoal(this));
    ...
    public static boolean checkSliverfishSpawnRules(EntityType<SilverHunter> p_223331_0_, IWorld p_223331_1_, SpawnReason p_223331_2_, BlockPos p_223331_3_, Random p_223331_4_) {
    ...
    static class HideInStoneGoal extends RandomWalkingGoal {
        ...
        public HideInStoneGoal(SilverHunter p_i45827_1_) {
    ...
    static class SummonSilverfishGoal extends Goal {
        private final SilverHunter silverfish;
        private int lookForFriends;

        public SummonSilverfishGoal(SilverHunter p_i45826_1_) {
